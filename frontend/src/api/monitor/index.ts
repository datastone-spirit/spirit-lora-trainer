 ...
 * @LastEditTime: 2025-08-13 15:19:04
...
/** 监听qwen image训练信息 */
export function qwenImageTrainingInfo(params: QwenImageTrainingInfoParams) {
	return request<QwenImageTrainingInfoResult>({
		url: "/tasks/history",
		method: "GET",
		params,
		showErrorMessage: false
