<!--
 * @Author: mulingyuer
 * @Date: 2025-04-01 16:17:04
 * @LastEditTime: 2025-04-02 11:46:23
 * @LastEditors: mulingyuer
 * @Description: 视频文件
 * @FilePath: \frontend\src\components\FileManager\FileItem\VideoFile.vue
 * 怎么可能会有bug！！！
-->
<template>
	<div class="file-list-item video-file">
		<el-image
