 ...
 * @LastEditTime: 2025-07-30 09:14:14
...
export interface InitData {
	...
	taskId: string;
	/** api返回的任务数据 */
	result: FluxKontextTrainingInfoResult;
	/** 是否显示训练提示弹窗 */
...
class FluxKontextLoraMonitor implements TaskImplementation {
	/** 定时器 */
	...
	/** 更新当前任务信息 */
	private updateCurrentTaskInfo(result?: FluxKontextTrainingInfoResult): void {
