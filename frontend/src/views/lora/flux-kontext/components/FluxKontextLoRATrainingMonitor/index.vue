 ...
 * @LastEditTime: 2025-07-30 09:35:49
 * @LastEditors: mulingyuer
 * @Description: flux kontext 训练监控
 * @FilePath: \frontend\src\views\lora\flux-kontext\components\FluxKontextLoRATrainingMonitor\index.vue
 * 怎么可能会有bug！！！
-->
<template>
	<div v-if="taskInfo.type === 'flux-kontext'" class="lo-ra-training-monitor">
