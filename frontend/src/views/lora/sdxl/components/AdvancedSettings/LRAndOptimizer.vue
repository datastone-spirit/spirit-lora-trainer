 ...
 * @LastEditTime: 2024-12-09 10:47:49
...
<template>
	<FieldSetWrapper title="学习率与优化器设置">
		<PopoverFormItem label="U-Net 学习率" :prop="formProps.unet_lr" popover-content="unet_lr">
			<el-input v-model="ruleForm.unet_lr" placeholder="请输入U-Net 学习率" />
		</PopoverFormItem>
		<PopoverFormItem
			label="文本编码器学习率"
			:prop="formProps.text_encoder_lr"
		...
		<PopoverFormItem
			label="重启次数"
			:prop="formProps.lr_scheduler_num_cycles"
...
export interface LRAndOptimizerProps {
	/** 表单props */
	formProps: RuleFormProps;
}

defineProps<LRAndOptimizerProps>();
