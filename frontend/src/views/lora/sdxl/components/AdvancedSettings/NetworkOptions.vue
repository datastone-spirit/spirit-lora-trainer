 ...
 * @LastEditTime: 2024-12-09 11:29:34
...
<template>
	<FieldSetWrapper title="网络设置">
		...
		>
			<el-select v-model="ruleForm.network_module" placeholder="请选择训练网络模块">
				<el-option
		...
		<template v-if="ruleForm.base_weights">
			<PopoverFormItem
...
const networkModuleOptions = readonly([
	{
		label: "networks.lora",
		value: "networks.lora"
	},
	{
		label: "networks.dylora",
		value: "networks.dylora"
	},
	{
		label: "networks.oft",
		value: "networks.oft"
