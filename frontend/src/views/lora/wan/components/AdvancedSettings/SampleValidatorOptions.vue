 ...
 * @LastEditTime: 2025-03-26 16:39:43
 * @LastEditors: mulingyuer
 * @Description: 采样与验证选项
 * @FilePath: \frontend\src\views\lora\wan\components\AdvancedSettings\SampleValidatorOptions.vue
 * 怎么可能会有bug！！！
-->
<template>
	<FieldSetWrapper title="采样与验证">
		<PopoverFormItem
			label="训练前生成初始样本"
