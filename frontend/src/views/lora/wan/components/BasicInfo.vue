 ...
 * @LastEditTime: 2025-03-26 09:40:10
...
<template>
	...
	<PopoverFormItem label="wan2模型地址" prop="config.dit" popover-content="dit">
		<FileSelector v-model="ruleForm.config.dit" placeholder="请选择训练用的wan2模型" />
	</PopoverFormItem>
	<PopoverFormItem v-show="isI2V" label="CLIP模型路径" prop="config.clip" popover-content="clip">
		<FileSelector v-model="ruleForm.config.clip" placeholder="请选择CLIP模型" />
	</PopoverFormItem>
	<PopoverFormItem label="T5模型" prop="config.t5" popover-content="t5">
		<FileSelector v-model="ruleForm.config.t5" placeholder="请选择T5模型" />
	</PopoverFormItem>
	<PopoverFormItem label="T5使用FP8模式" prop="config.fp8_t5" popover-content="fp8_t5">
		<el-switch v-model="ruleForm.config.fp8_t5" />
	</PopoverFormItem>
	<PopoverFormItem label="VAE模型路径" prop="config.vae" popover-content="vae">
	...
	<PopoverFormItem label="VAE模型的计算精度" prop="config.vae_dtype" popover-content="vae_dtype">
